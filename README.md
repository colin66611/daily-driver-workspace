...
| 文件夹 | 用途 | 示例 |
|--------|------|------|
| **work/** | 工作项目、职场相关 | 项目文档、会议纪要、技术方案 |
| **learning/** | 学习积累、知识沉淀 | 读书笔记、课程笔记、技术研究 |
| **life/** | 生活管理、个人事务 | 健康记录、财务规划、家庭事项 |
| **others/daily/** | 每日任务执行区 | Daily Driver 的工作目录 |
| **others/demo/** | 演示、测试、临时 | 实验性内容、草稿 |

**怎么决定放哪？**
- 任务创建时，Agent 会问你要放到哪个分类
- 完成后可归档到对应分类的长期存储区
